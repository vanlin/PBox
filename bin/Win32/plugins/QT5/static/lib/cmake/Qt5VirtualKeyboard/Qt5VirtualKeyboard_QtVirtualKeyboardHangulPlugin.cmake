...
_qt5_VirtualKeyboard_process_prl_file(
    "${_qt5VirtualKeyboard_install_prefix}/plugins/virtualkeyboard/qtvirtualkeyboard_hangul.prl" RELEASE
    _Qt5QtVirtualKeyboardHangulPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QtVirtualKeyboardHangulPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QtVirtualKeyboardHangulPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5VirtualKeyboard_QtVirtualKeyboardHangulPlugin_Import.cpp"
)

_populate_VirtualKeyboard_plugin_properties(QtVirtualKeyboardHangulPlugin RELEASE "virtualkeyboard/qtvirtualkeyboard_hangul.lib" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QtVirtualKeyboardHangulPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QtVirtualKeyboardHangulPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QtVirtualKeyboardHangulPlugin,QT_PLUGIN_EXTENDS>,Qt::VirtualKeyboard>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QtVirtualKeyboardHangulPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QtVirtualKeyboardHangulPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QtVirtualKeyboardHangulPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QtVirtualKeyboardHangulPlugin>"
)
set_property(TARGET Qt5::VirtualKeyboard APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ${_plugin_genex}
)
set_property(TARGET Qt5::QtVirtualKeyboardHangulPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
