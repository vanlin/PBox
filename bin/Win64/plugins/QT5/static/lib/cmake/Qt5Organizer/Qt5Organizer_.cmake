...
set(_Qt5_MODULE_DEPENDENCIES "Organizer;Core")

foreach(_module_dep ${_Qt5_MODULE_DEPENDENCIES})
    if(NOT Qt5${_module_dep}_FOUND)
        find_package(Qt5${_module_dep}
             ${_Qt5Organizer_FIND_VERSION_EXACT}
...
_qt5_Organizer_process_prl_file(
    "${_qt5Organizer_install_prefix}/plugins/organizer/qtorganizer_memory.prl" RELEASE
...
set_property(TARGET Qt5:: PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Organizer__Import.cpp"
)

_populate_Organizer_plugin_properties( RELEASE "organizer/qtorganizer_memory.lib" FALSE)
...
if(CMAKE_VERSION VERSION_LESS "3.12")
    ...
    set(_plugin_type_genex "$<TARGET_PROPERTY:QT_PLUGINS_organizer>")
    set(_no_plugins_genex "$<TARGET_PROPERTY:QT_NO_PLUGINS>")
else()
    set(_manual_plugins_genex "$<GENEX_EVAL:$<TARGET_PROPERTY:QT_PLUGINS>>")
    set(_plugin_type_genex "$<GENEX_EVAL:$<TARGET_PROPERTY:QT_PLUGINS_organizer>>")
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::,QT_PLUGIN_EXTENDS>,Qt::Organizer>,"
