...
_qt5_Qml_process_prl_file(
    "${_qt5Qml_install_prefix}/plugins/qmltooling/qmldbg_native.prl" RELEASE
...
_populate_Qml_plugin_properties(QQmlNativeDebugConnectorFactory RELEASE "qmltooling/qmldbg_native.lib" FALSE)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QQmlNativeDebugConnectorFactory,QT_PLUGIN_EXTENDS>,Qt::Qml>,"
