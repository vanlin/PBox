...
const CurrentVersionNumber = '3.00.09';

const HEADERSIZINGHORIZ_MARG = 6;
const HEADERSIZINGHORIZHIDDEN_MARG = 2;
const HEADERSIZINGVERT_MARG = 4;

const COMMENT_CELLOFFS_X = 15;
const COMMENT_CELLOFFS_Y = -10;
const COMMENT_MARGIN     = 3;

const CONDFMT_ICON_SIZE  = 16;
