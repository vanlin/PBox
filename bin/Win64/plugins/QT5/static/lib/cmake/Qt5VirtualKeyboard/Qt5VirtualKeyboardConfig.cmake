...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard.lib" "" FALSE)

    if (EXISTS "${_qt5VirtualKeyboard_install_prefix}/lib/Qt5VirtualKeyboardd.lib" )
        _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboardd.lib" "" FALSE)
    endif()
