...
uses Classes, SysUtils, Types, Controls, StdCtrls, ComCtrls, Forms, Graphics,
     Windows, ExtCtrls, Math,
     ExcelColorPicker,
...
protected
     ...
     FBMPTrueType: Graphics.TBitmap;
     FBMPPrinter : Graphics.TBitmap;
...
begin
  ...
  FBMPTrueType := Graphics.TBitmap.Create;
  FBMPPrinter := Graphics.TBitmap.Create;
