...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QShakeSensorGesturePlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QShakeSensorGesturePlugin,QT_PLUGIN_EXTENDS>,Qt::Sensors>,"
            ...
            "$<NOT:$<IN_LIST:Qt::QShakeSensorGesturePlugin,${_no_plugins_genex}>>"
        ">"
