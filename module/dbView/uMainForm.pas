...
uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.StrUtils, System.Variants, System.Classes, System.Win.Registry, System.IniFiles, System.Types, System.IOUtils, System.JSON,
...
type
  ...
  private
    ...
    { 获取表结构信息 }
    procedure GetTableFieldsInfo(const strTableName: string);
    { 获取表所有数据 }
    procedure GetTableDataInfo(const strTableName: string);
    { 获取字段类型 }
...
{ 获取所有表 }
procedure TfrmdbView.GetAllTables;
begin
  lstTables.Clear;
...
begin
  ...
  { 获取表结构信息 }
  GetTableFieldsInfo(lstTables.Items[lstTables.ItemIndex]);

  { 获取表所有数据 }
  GetTableDataInfo(lstTables.Items[lstTables.ItemIndex]);
end;
...
{ 获取表结构信息 }
procedure TfrmdbView.GetTableFieldsInfo(const strTableName: string);
const
...
{ 获取表所有数据 }
procedure TfrmdbView.GetTableDataInfo(const strTableName: string);
var
  strAutoID: String;
  strFields: String;
begin
