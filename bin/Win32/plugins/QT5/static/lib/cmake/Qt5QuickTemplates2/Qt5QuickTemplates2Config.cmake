...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "Qt5QuickTemplates2.lib" "" FALSE)

    if (EXISTS "${_qt5QuickTemplates2_install_prefix}/lib/Qt5QuickTemplates2d.lib" )
        _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2d.lib" "" FALSE)
    endif()
