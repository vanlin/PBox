...
set(_Qt5_MODULE_DEPENDENCIES "Feedback;Multimedia;Core")

foreach(_module_dep ${_Qt5_MODULE_DEPENDENCIES})
    if(NOT Qt5${_module_dep}_FOUND)
        find_package(Qt5${_module_dep}
             ${_Qt5Feedback_FIND_VERSION_EXACT}
...
_qt5_Feedback_process_prl_file(
    "${_qt5Feedback_install_prefix}/plugins/feedback/qtfeedback_mmk.prl" RELEASE
...
set_property(TARGET Qt5:: PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Feedback__Import.cpp"
)

_populate_Feedback_plugin_properties( RELEASE "feedback/qtfeedback_mmk.lib" FALSE)
...
if(CMAKE_VERSION VERSION_LESS "3.12")
    ...
    set(_plugin_type_genex "$<TARGET_PROPERTY:QT_PLUGINS_feedback>")
    set(_no_plugins_genex "$<TARGET_PROPERTY:QT_NO_PLUGINS>")
else()
    set(_manual_plugins_genex "$<GENEX_EVAL:$<TARGET_PROPERTY:QT_PLUGINS>>")
    set(_plugin_type_genex "$<GENEX_EVAL:$<TARGET_PROPERTY:QT_PLUGINS_feedback>>")
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::,QT_PLUGIN_EXTENDS>,Qt::Feedback>,"
...
set_property(TARGET Qt5:: APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Feedback;Qt5::Multimedia;Qt5::Core"
)
