...
if (NOT TARGET Qt5::Bodymovin)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Bodymovin_process_prl_file(
            "${_qt5Bodymovin_install_prefix}/lib/Qt5Bodymovin.prl" RELEASE
    ...
    _populate_Bodymovin_target_properties(RELEASE "Qt5Bodymovin.lib" "" FALSE)

    if (EXISTS "${_qt5Bodymovin_install_prefix}/lib/Qt5Bodymovind.lib" )
        _populate_Bodymovin_target_properties(DEBUG "Qt5Bodymovind.lib" "" FALSE)
    endif()
