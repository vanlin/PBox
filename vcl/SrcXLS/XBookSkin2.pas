...
uses { Delphi  } Classes, SysUtils, Windows, Types, Controls, Contnrs, Graphics,
...
var
  bmpBtnTabSet : Graphics.TBitmap;
  bmpBtnOutline: Graphics.TBitmap;
  bmpBtnNumbers: Graphics.TBitmap;

  bmpTabMove   : Graphics.TBitmap;
  bmpNote      : Graphics.TBitmap;
  bmpCheckBox  : Graphics.TBitmap;
  bmpHSplit    : Graphics.TBitmap;
  bmpVSplit    : Graphics.TBitmap;
...
begin
  bmpBtnTabSet := Graphics.TBitmap.Create;
