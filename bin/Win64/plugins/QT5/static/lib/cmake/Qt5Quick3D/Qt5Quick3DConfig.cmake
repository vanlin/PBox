...
if (NOT TARGET Qt5::Quick3D)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_Quick3D_process_prl_file(
            "${_qt5Quick3D_install_prefix}/lib/Qt5Quick3D.prl" RELEASE
    ...
    _populate_Quick3D_target_properties(RELEASE "Qt5Quick3D.lib" "" FALSE)

    if (EXISTS "${_qt5Quick3D_install_prefix}/lib/Qt5Quick3Dd.lib" )
        _populate_Quick3D_target_properties(DEBUG "Qt5Quick3Dd.lib" "" FALSE)
    endif()
