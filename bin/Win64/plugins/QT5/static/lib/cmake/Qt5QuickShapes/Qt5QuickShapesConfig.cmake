...
if (NOT TARGET Qt5::QuickShapes)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_QuickShapes_process_prl_file(
            "${_qt5QuickShapes_install_prefix}/lib/Qt5QuickShapes.prl" RELEASE
    ...
    _populate_QuickShapes_target_properties(RELEASE "Qt5QuickShapes.lib" "" FALSE)

    if (EXISTS "${_qt5QuickShapes_install_prefix}/lib/Qt5QuickShapesd.lib" )
        _populate_QuickShapes_target_properties(DEBUG "Qt5QuickShapesd.lib" "" FALSE)
    endif()
