...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    _populate_3DQuickRender_target_properties(RELEASE "Qt53DQuickRender.lib" "" FALSE)

    if (EXISTS "${_qt53DQuickRender_install_prefix}/lib/Qt53DQuickRenderd.lib" )
        _populate_3DQuickRender_target_properties(DEBUG "Qt53DQuickRenderd.lib" "" FALSE)
    endif()
