...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::SystecCanBusPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::SystecCanBusPlugin,QT_PLUGIN_EXTENDS>,Qt::SerialBus>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::SystecCanBusPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::SystecCanBusPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::SystecCanBusPlugin,${_no_plugins_genex}>>"
        ">"
