...
set(_Qt5_MODULE_DEPENDENCIES "Gui;Versit;Contacts;Core")

foreach(_module_dep ${_Qt5_MODULE_DEPENDENCIES})
    if(NOT Qt5${_module_dep}_FOUND)
        find_package(Qt5${_module_dep}
             ${_Qt5Versit_FIND_VERSION_EXACT}
...
_qt5_Versit_process_prl_file(
    "${_qt5Versit_install_prefix}/plugins/versit/qtversit_vcardpreserver.prl" RELEASE
...
set_property(TARGET Qt5:: PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Versit__Import.cpp"
)

_populate_Versit_plugin_properties( RELEASE "versit/qtversit_vcardpreserver.lib" FALSE)
...
if(CMAKE_VERSION VERSION_LESS "3.12")
    ...
    set(_plugin_type_genex "$<TARGET_PROPERTY:QT_PLUGINS_versit>")
    set(_no_plugins_genex "$<TARGET_PROPERTY:QT_NO_PLUGINS>")
else()
    set(_manual_plugins_genex "$<GENEX_EVAL:$<TARGET_PROPERTY:QT_PLUGINS>>")
    set(_plugin_type_genex "$<GENEX_EVAL:$<TARGET_PROPERTY:QT_PLUGINS_versit>>")
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::,QT_PLUGIN_EXTENDS>,Qt::Versit>,"
...
set_property(TARGET Qt5:: APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Gui;Qt5::Versit;Qt5::Contacts;Qt5::Core"
)
