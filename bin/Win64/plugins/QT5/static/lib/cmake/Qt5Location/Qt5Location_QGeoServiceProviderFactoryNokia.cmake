...
set(_Qt5QGeoServiceProviderFactoryNokia_MODULE_DEPENDENCIES "Location;Location;Location;Location;Location;Location;Location;Location;Location;Location;Location;Location;Gui;Positioning;Network;Core")
...
_qt5_Location_process_prl_file(
    "${_qt5Location_install_prefix}/plugins/geoservices/qtgeoservices_nokia.prl" RELEASE
...
_populate_Location_plugin_properties(QGeoServiceProviderFactoryNokia RELEASE "geoservices/qtgeoservices_nokia.lib" FALSE)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QGeoServiceProviderFactoryNokia,QT_PLUGIN_EXTENDS>,Qt::Location>,"
...
set_property(TARGET Qt5::QGeoServiceProviderFactoryNokia APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Location;Qt5::Gui;Qt5::Positioning;Qt5::Network;Qt5::Core"
)
